...
ffi::Error TridiagonalSolvePerturbedFfiImpl(ffi::AnyBuffer dl, ffi::AnyBuffer d,
  ...
  for (int64_t i = 0; i < batch_count; ++i) {
    switch (dtype) {
      case ffi::DataType::F32: {
        ...
        SolveWithGaussianEliminationWithPivotingAndPerturbSingular<float>(
            b_rows, b_cols, reinterpret_cast<const float*>(dl_data),
            reinterpret_cast<const float*>(d_data),
            reinterpret_cast<const float*>(du_data),
            reinterpret_cast<const float*>(b_data),
            reinterpret_cast<float*>(x_out_data), workspace.data(),
      ...
      case ffi::DataType::F64: {
        ...
        SolveWithGaussianEliminationWithPivotingAndPerturbSingular<double>(
            b_rows, b_cols, reinterpret_cast<const double*>(dl_data),
            reinterpret_cast<const double*>(d_data),
            reinterpret_cast<const double*>(du_data),
            reinterpret_cast<const double*>(b_data),
            reinterpret_cast<double*>(x_out_data), workspace.data(),
            rhs_row_workspace.data());
        break;
      }
      case ffi::DataType::C64: {
        ...
        SolveWithGaussianEliminationWithPivotingAndPerturbSingular<
            std::complex<float>>(
            b_rows, b_cols,
            reinterpret_cast<const std::complex<float>*>(dl_data),
            reinterpret_cast<const std::complex<float>*>(d_data),
            reinterpret_cast<const std::complex<float>*>(du_data),
            reinterpret_cast<const std::complex<float>*>(b_data),
            reinterpret_cast<std::complex<float>*>(x_out_data),
      ...
      case ffi::DataType::C128: {
        ...
        SolveWithGaussianEliminationWithPivotingAndPerturbSingular<
            std::complex<double>>(
            b_rows, b_cols,
            reinterpret_cast<const std::complex<double>*>(dl_data),
            reinterpret_cast<const std::complex<double>*>(d_data),
            reinterpret_cast<const std::complex<double>*>(du_data),
            reinterpret_cast<const std::complex<double>*>(b_data),
            reinterpret_cast<std::complex<double>*>(x_out_data),
            workspace.data(), rhs_row_workspace.data());
        break;
      }
      default:
    ...
    dl_data = static_cast<char*>(dl_data) + d_step * ffi::ByteWidth(dtype);
    d_data = static_cast<char*>(d_data) + d_step * ffi::ByteWidth(dtype);
    du_data = static_cast<char*>(du_data) + d_step * ffi::ByteWidth(dtype);
    b_data = static_cast<char*>(b_data) + b_step * ffi::ByteWidth(dtype);
    x_out_data =
        static_cast<char*>(x_out_data) + b_step * ffi::ByteWidth(dtype);
  }
